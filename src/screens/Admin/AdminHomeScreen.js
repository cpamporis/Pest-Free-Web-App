...
const [
  ...
  if (
    ...
    showAlert(
      i18n.t("common.error"),
      i18n.t(
        "admin.password.errors.required"
      )
    );
    return;
  }
  ...
  if (
    ...
    showAlert(
      i18n.t("common.error"),
      i18n.t(
        "admin.password.errors.notMatching"
      )
    );
    return;
  }
  ...
  try {
    ...
    showAlert(
      i18n.t(
        "admin.password.successTitle"
      ),
      i18n.t(
        "admin.password.successMessage"
      ),
      [
        {
